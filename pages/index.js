    ...
    return (
        <>
            ...
            <div className="center-H">
                <br></br>
                <h1>
                    Welcome to the <span className="highlighted">Astro Booking System</span>
                </h1>
                <br></br>
                <h2>This is how it works:</h2>
                <h3>
                    On the time schedule page, you can view all slots. You can book a free one by clicking on it and filling out the form. A confirmation email
                ...
                <h3>Once you choose a time slot, you can only book slots within that time frame.</h3>
                <h3>
